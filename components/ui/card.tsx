  ...
  return (
    <div
      ...
      className={cn(
        ...
        "shadow-[0_1px_2px_oklch(0.14_0.025_260/0.04),0_4px_12px_oklch(0.14_0.025_260/0.04)]",
        className
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("font-semibold text-[16px] leading-snug tracking-tight", className)}
      {...props}
    />
  )
}
